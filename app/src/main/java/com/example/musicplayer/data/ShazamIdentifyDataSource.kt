...
import com.example.musicplayer.converters.toMusic
import com.example.musicplayer.converters.toShortArray
import com.example.musicplayer.model.Music
import com.example.musicplayer.native.ShazamSignature
...
class ShazamIdentifyDataSource : IdentifyDataSource {
    ...
    override suspend fun identify(data: ByteArray, duration: Int): Music? {
        ...
        Log.e("Recognize", "Recognize: " + response.body().toString())
